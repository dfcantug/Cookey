...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainPageCookBook = function (_React$Component) {
	  _inherits(MainPageCookBook, _React$Component);
	
	  function MainPageCookBook() {
	    _classCallCheck(this, MainPageCookBook);
	
	    return _possibleConstructorReturn(this, (MainPageCookBook.__proto__ || Object.getPrototypeOf(MainPageCookBook)).apply(this, arguments));
	  }
	
	  _createClass(MainPageCookBook, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Recipe, null)
	      );
	    }
	  }]);
	
	  return MainPageCookBook;
	...
	(0, _reactDom.render)(_react2.default.createElement(MainPageCookBook, null), document.getElementById('rootCookBook'));
